...
if [ -f "$OUTPUT_DIR/database-er-diagram.mmd" ]; then
    cat "$OUTPUT_DIR/database-er-diagram.mmd" >> "$OUTPUT_FILE"
else
    echo "erDiagram" >> "$OUTPUT_FILE"
    echo "    %% Diagram will be generated by generate-er-diagram.sh" >> "$OUTPUT_FILE"
fi
