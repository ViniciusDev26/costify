...
public class RegisterIngredientUseCase {
    ...
    public RegisterIngredientUseCase(IngredientRepository ingredientRepository, IngredientFactory ingredientFactory) {
    ...
    public static class IngredientAlreadyExistsException extends RuntimeException {
