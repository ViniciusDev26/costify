...
public class IngredientFactory {
    ...
    public Ingredient create(String name, double packageQuantity, double packagePrice, Unit packageUnit) {
        return createIngredient(idGenerator, name, packageQuantity, packagePrice, packageUnit);
    }
    
    public Ingredient create(Id id, String name, double packageQuantity, double packagePrice, Unit packageUnit) {
        return createIngredient(id, name, packageQuantity, packagePrice, packageUnit);
    }
    
    private Ingredient createIngredient(IdGenerator idGenerator, String name, double packageQuantity, double packagePrice, Unit packageUnit) {
        return new Ingredient(idGenerator, name, packageQuantity, packagePrice, packageUnit);
    }
    
    private Ingredient createIngredient(Id id, String name, double packageQuantity, double packagePrice, Unit packageUnit) {
