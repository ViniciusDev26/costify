...
COMMENT ON COLUMN ingredients.package_unit IS 'Unit of measurement for the package (KG, G, L, ML, UNITS)';
COMMENT ON COLUMN ingredients.unit_cost IS 'Calculated cost per base unit';
