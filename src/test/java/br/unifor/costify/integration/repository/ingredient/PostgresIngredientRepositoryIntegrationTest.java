...
class PostgresIngredientRepositoryIntegrationTest {
    ...
    void save_shouldHandleDifferentUnits() {
        ...
        Ingredient gramIngredient = new Ingredient(
            Id.of("gram-ingredient"),
            "Flour",
            500.0,
            3.20,
            Unit.G
        ...
        Ingredient kgIngredient = new Ingredient(
            Id.of("kg-ingredient"),
            "Sugar",
            1.0,
            4.50,
        ...
        Ingredient mlIngredient = new Ingredient(
            Id.of("ml-ingredient"),
            "Vanilla Extract",
            50.0,
            8.90,
