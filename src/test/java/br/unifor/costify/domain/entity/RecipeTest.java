...
class RecipeTest {
    ...
    void createRecipe_withIdGenerator_shouldInitializeCorrectly() {
        Recipe recipe = new Recipe(fakeIdGenerator, "Bread Recipe", List.of(recipeIngredient1, recipeIngredient2));
    ...
    void removeIngredient_shouldRemoveFromList() {
        Recipe recipe = new Recipe(fakeIdGenerator, "Test Recipe", List.of(recipeIngredient1, recipeIngredient2));
